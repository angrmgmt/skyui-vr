class skyui.util.GlobalFunctions
{
   ...
   static function formatString(a_str)
   {
      ...
      {
         var _loc7_ = a_str.indexOf("{",_loc8_);
         if(_loc7_ == -1)
         {
            return a_str;
         }
         var _loc5_ = a_str.indexOf("}",_loc8_);
         if(_loc5_ == -1)
         {
            return a_str;
         }
         _loc12_ = _loc12_ + a_str.slice(_loc8_,_loc7_);
         var _loc4_ = Number(a_str.slice(_loc7_ + 1,_loc5_));
         var _loc10_ = Math.pow(10,_loc4_);
         var _loc2_ = (Math.round(arguments[_loc6_] * _loc10_) / _loc10_).toString();
         if(_loc4_ > 0)
         {
            if(_loc2_.indexOf(".") == -1)
            {
      ...
      _loc12_ = _loc12_ + a_str.slice(_loc8_);
      return _loc12_;
   }
   static function formatNumber(a_number, a_decimal)
   {
      ...
      if(a_decimal > 0)
      {
         ...
         var _loc4_ = _loc2_.length - (_loc5_ + 1);
         var _loc1_ = 0;
