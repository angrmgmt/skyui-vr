class CategoryList extends skyui.components.list.BasicList
{
   ...
   function __set__activeSegment(a_segment)
   {
      ...
      this.UpdateList();
      return this.__get__activeSegment();
   }
   function __get__activeSegment()
   {
      return this._activeSegment;
   }
   function selectionAtBeginningOfSegment()
   {
      if(this.__get__selectedIndex() == 0)
      {
         return true;
      }
      if(this.dividerIndex != -1 && this.__get__selectedIndex() == this.dividerIndex + 1)
      {
         return true;
      }
      return false;
   }
   function selectionAtEndOfSegment()
   {
      if(this.__get__selectedIndex() == this.__get__entryList().length)
      {
         return true;
      }
      if(this.dividerIndex != -1 && this.__get__selectedIndex() == this.dividerIndex - 1)
   ...
   function UpdateList()
   {
      ...
      {
         var _loc3_ = this.getClipByIndex(_loc2_);
